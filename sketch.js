...
function setup()
{
   ...
   //creating Pyramid 2 {
    ...
    //level four
    block10 = new Block2(800, 275, 35, 50);
    block11 = new Block2(835, 275, 35, 50);
    block12 = new Block2(865, 275, 35, 50);
    block13 = new Block2(900, 275, 35, 50);
    block14 = new Block2(765, 275, 35, 50);
    block15 = new Block2(735, 275, 35, 50);
    block16 = new Block2(700, 275, 35, 50);
    //level three
    block17 = new Block2(735, 225, 35, 50);
    block18 = new Block2(770, 225, 35, 50);
    block19 = new Block2(835, 225, 35, 50);
    block20 = new Block2(865, 225, 35, 50);
    block21 = new Block2(800, 225, 35, 50);
    //level two
    block22 = new Block2(770, 175, 35, 50);
    block23 = new Block2(800, 175, 35, 50);
    block24 = new Block2(835, 175, 35, 50);
    //top level
    block25 = new Block2(800, 125, 35, 50);
...
function draw()
{
    ...
    text("Press SPACE BAR  to get another chance", 350, 340);
...
function keyPressed() {
	if (keyCode === 32) {
    Matter.Body.setPosition(polygonStone.body, {x:1000, y:230}) 
